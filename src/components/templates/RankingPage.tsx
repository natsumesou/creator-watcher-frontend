...
const RankingPage: React.FC<PageContext> = ({pageContext}) => {
  ...
  const notices = {
    daily: ["デイリーランキングは毎日朝9時過ぎに前日の朝5時〜当日の朝5時前後の枠のスパチャ金額・メンバー加入数を更新しています", "※ランキングの対象は「にじさんじ」「ホロライブ」タブでリストされているチャンネルのみになります"],
    weekly: ["ウィークリーランキングは毎週月曜の朝9時過ぎに前週分のスパチャ金額・メンバー加入数を更新しています", "※ランキングの対象は「にじさんじ」「ホロライブ」タブでリストされているチャンネルのみになります"],
    monthly: ["マンスリーランキングは毎月１日の朝9時過ぎに前月分のスパチャ金額・メンバー加入数を更新しています","※ランキングの対象は「にじさんじ」「ホロライブ」タブでリストされているチャンネルのみになります"],
  }
